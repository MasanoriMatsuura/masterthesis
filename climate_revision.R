...
rin_data2$r3 <- apply(rin_data2[87:89],1,sum) #2017/2018Rabi
...
rin_data3$lr3 <- apply(rin_data3[87:89],1,sum) #2016/2017Rabi
...
rin_data4$tlr3 <- apply(rin_data4[87:89],1,sum) #2015/2016Rabi
...
tmp_data2$tr3 <- apply(tmp_data2[87:89],1,mean) #2017/2018Rabi
...
tmp_data3$ltr3 <- apply(tmp_data3[87:89],1,mean) #2016/2017Rabi
...
tmp_data4$tltr3 <- apply(tmp_data4[87:89],1,mean) #2015/2016Rabi
